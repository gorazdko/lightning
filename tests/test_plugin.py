...
def test_htlc_lifecycle(node_factory):
    ...
    # get the corresponding payloads of the htlc events for every node
    l1_data = l1.rpc.call('htlc_plugin')['data']
    l2_data = l2.rpc.call('htlc_plugin')['data']
    ...
    assert "failreason" not in l1.rpc.call('htlc_plugin')['data'][-1]
    assert "WIRE_INVALID_ONION_HMAC" == l2.rpc.call('htlc_plugin')['data'][-1]['failreason']
    assert "WIRE_INVALID_ONION_KEY" == l3.rpc.call('htlc_plugin')['data'][-1]['failreason']
